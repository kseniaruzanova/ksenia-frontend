...
// Функции для отслеживания прогресса генерации видео
async function startProgressPolling(reelId: string) {
  ...
  // Запускаем сразу и затем каждые 2 секунды
  await poll()
  progressPollingInterval.value = setInterval(poll, 2000)
}
