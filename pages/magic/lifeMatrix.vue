      ...
      <div class="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
        <div class="max-w-4xl mx-auto">
          <div class="text-center mb-8">
            <h1 class="text-3xl font-bold text-gray-900">🔮 Матрица жизни</h1>
            <p class="mt-4 text-lg text-gray-600">
              Получите полный расчет вашей матрицы жизни с арканами и периодами
            </p>
          </div>
          ...
          <div class="bg-white rounded-lg shadow-lg p-8">
            <h2 class="text-2xl font-semibold text-gray-800 mb-6 text-center">Матрица жизни</h2>
            ...
            <div class="prose max-w-none space-y-6">
              <div class="text-center mb-8">
                <p class="text-lg text-gray-700 leading-relaxed">
                  Матрица жизни — это полный расчет вашей судьбы, включающий матрицу, арканы дня рождения, года, задачи высших сил, урок на это воплощение, аркан самореализации и подробное описание пяти периодов жизни.
                </p>
              </div>
              ...
              <div class="grid md:grid-cols-2 gap-6">
                ...
                <div class="border-2 border-purple-200 rounded-lg p-6 hover:shadow-lg transition-shadow">
                  <div class="flex items-center mb-4">
                    ...
                    <h3 class="text-lg font-semibold text-gray-800">Арканы судьбы</h3>
                  </div>
                  <p class="text-gray-700">
                    Узнайте аркан дня рождения, года, задачи высших сил, урок на это воплощение и аркан самореализации.
                  </p>
                </div>
                ...
                <div class="border-2 border-blue-200 rounded-lg p-6 hover:shadow-lg transition-shadow">
                  <div class="flex items-center mb-4">
                    ...
                    <h3 class="text-lg font-semibold text-gray-800">Матрица</h3>
                  </div>
                  <p class="text-gray-700">
                    Получите полную матрицу жизни с расчетом всех энергетических центров.
                  </p>
                </div>
                ...
                <div class="border-2 border-green-200 rounded-lg p-6 hover:shadow-lg transition-shadow">
                  <div class="flex items-center mb-4">
                    ...
                    <h3 class="text-lg font-semibold text-gray-800">Периоды жизни</h3>
                  </div>
                  <p class="text-gray-700">
                    Узнайте подробное описание пяти периодов вашей жизни с положительными событиями, бонусами и кармическими уроками.
                  </p>
                </div>
                ...
                <div class="border-2 border-yellow-200 rounded-lg p-6 hover:shadow-lg transition-shadow">
                  <div class="flex items-center mb-4">
                    ...
                    <h3 class="text-lg font-semibold text-gray-800">Кармические уроки</h3>
                  </div>
                  <p class="text-gray-700">
                    Поймите, какие кармические уроки, ошибки и черты характера нельзя повторять в каждом периоде.
                  </p>
                </div>
              </div>
              ...
              <div class="bg-gradient-to-r from-purple-50 to-blue-50 rounded-lg p-6 mt-8">
                ...
                <ul class="space-y-3 text-gray-700">
                  <li class="flex items-start">
                    ...
                    <span>Полная матрица жизни с расчетом всех энергетических центров</span>
                  </li>
                  <li class="flex items-start">
                    <svg class="w-6 h-6 text-purple-600 mr-2 flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path>
                    </svg>
                    <span>Аркан дня рождения, года, задачи высших сил, урок на воплощение и самореализации</span>
                  </li>
                  <li class="flex items-start">
                    <svg class="w-6 h-6 text-purple-600 mr-2 flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path>
                    </svg>
                    <span>Таблица пяти периодов жизни с возрастными рамками</span>
                  </li>
                  <li class="flex items-start">
                    <svg class="w-6 h-6 text-purple-600 mr-2 flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path>
                    </svg>
                    <span>Подробное описание каждого периода: положительные события, бонусы, препятствия и кармические уроки</span>
                  </li>
                </ul>
              </div>
            </div>
          ...
          <!-- Контент продукта -->
          <ProductContentBlock 
            product-type="lifeMatrix" 
            product-id="taroscope-lifeMatrix" 
            product-display-name="Матрица жизни" 
          />
        </div>
      </div>
    </template>
...
async function generateReport() {
  ...
  try {
    const response = await fetch(`${config.public.apiBase}/api/lifeMatrix/pdf`, {
      method: 'POST',
      headers: {
