      ...
      <div class="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
        <div class="max-w-4xl mx-auto">
          <div class="text-center mb-8">
            <h1 class="text-3xl font-bold text-gray-900">⚡ Удар, цикл, застой, выход</h1>
            <p class="mt-4 text-lg text-gray-600">
              Узнайте свой цикл жизни: застой, удар и три пути выхода по вашей дате рождения.
            </p>
          </div>
            ...
            <form @submit.prevent="generateForecast" class="space-y-6">
              ...
              <div>
                <label for="chooseMonth" class="block text-sm font-medium text-gray-700 mb-2">
                  Выберите дополнительный месяц для анализа
                </label>
                <select
                  id="chooseMonth"
                ...
                <p class="mt-1 text-sm text-gray-500">
                  Выберите месяц для углубленного анализа жизненного цикла
                </p>
              </div>
          ...
          <div class="bg-white rounded-lg shadow-lg p-8">
            <h2 class="text-2xl font-semibold text-gray-800 mb-6 text-center">Удар, цикл, застой, выход</h2>
            ...
            <div class="prose max-w-none space-y-6">
              <div class="text-center mb-8">
                <p class="text-lg text-gray-700 leading-relaxed">
                  Узнайте свой жизненный цикл: где вы находитесь сейчас, какой удар может произойти и какие три пути выхода вам доступны.
                </p>
              </div>
              ...
              <div class="grid md:grid-cols-2 gap-6">
                ...
                <div class="border-2 border-blue-200 rounded-lg p-6 hover:shadow-lg transition-shadow">
                  <div class="flex items-center mb-4">
                    ...
                    <h3 class="text-lg font-semibold text-gray-800">Пять трактовок</h3>
                  </div>
                  <p class="text-gray-700">
                    Файл содержит трактовки для ЗАСТОЯ, УДАРА и трех ВЫХОДОВ. Тексты подтягиваются из JSON, поэтому вы легко перепишете их под себя.
                  </p>
                </div>
                ...
                <div class="border-2 border-yellow-200 rounded-lg p-6 hover:shadow-lg transition-shadow">
                  ...
                  <p class="text-gray-700">
                    Мгновенное получение расчета жизненного цикла без сложных вычислений и длительного ожидания.
                  </p>
                </div>
              </div>
              ...
              <div class="bg-gradient-to-r from-purple-50 to-blue-50 rounded-lg p-6 mt-8">
                ...
                <ul class="space-y-3 text-gray-700">
                  ...
                  <li class="flex items-start">
                    ...
                    <span>Трактовка ЗАСТОЯ - где вы находитесь сейчас</span>
                  </li>
                  <li class="flex items-start">
                    <svg class="w-6 h-6 text-purple-600 mr-2 flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path>
                    </svg>
                    <span>Трактовка УДАРА - что может произойти</span>
                  </li>
                  <li class="flex items-start">
                    <svg class="w-6 h-6 text-purple-600 mr-2 flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path>
                    </svg>
                    <span>Три пути ВЫХОДА - варианты развития событий</span>
                  </li>
                  <li class="flex items-start">
                    <svg class="w-6 h-6 text-purple-600 mr-2 flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path>
                    </svg>
                    <span>Анализ выбранного месяца для углубленного понимания цикла</span>
                  </li>
                  <li class="flex items-start">
                    <svg class="w-6 h-6 text-purple-600 mr-2 flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path>
          ...
          <ProductContentBlock 
            product-type="stagnationCycle" 
            product-id="taroscope-stagnationCycle" 
            product-display-name="Удар, цикл, застой, выход" 
          />
        </div>
      </div>
    </template>
...
async function generateForecast() {
  ...
  if (!formData.value.chooseMonth) {
    error.value = 'Пожалуйста, выберите дополнительный месяц для анализа';
    return;
  }
  ...
  try {
    const response = await fetch(`${config.public.apiBase}/api/stagnationCycle/pdf`, {
      method: 'POST',
      headers: {
    ...
    let filename = 'stagnationCycle.pdf';
